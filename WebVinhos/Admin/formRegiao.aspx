<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Admin/indice2.master" AutoEventWireup="true" CodeBehind="formRegiao.aspx.cs" Inherits="WebVinhos.Admin.formRegiao" %>
            ...
            <div class="container d-flex flex-column">
                ...
                <div class="row g-3 divCaixaForms">
                    ...
                    <div class="col-md-12 divTitulo">
                        <asp:Label ID="LabelRegiao" runat="server" Text="Regiões" CssClass="tituloLabel"></asp:Label>
                    </div>
                    ...
                    <%-- Descricao --%>
                    <div class="col-md-3">
                        <asp:Label ID="LabelDescricao" runat="server" Text="Descrição" CssClass="form-label camposLabel"></asp:Label>
                    </div>
                    <div class="col-md-9">
                        <asp:TextBox ID="TextBoxDescricao" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            <asp:LinkButton ID="LinkButtonInserir" runat="server" CssClass="camposLabel linkButton" OnClick="LinkButtonInserir_Click" Visible="False" Text="Inserir" CausesValidation="False"></asp:LinkButton>
                        </div>
                    </div>
                    ...
                    <%-- Regioes Registados --%>
                    <div class="col-md-12 divTitulo">
                        <asp:Label ID="LabelRegioesRegistados" runat="server" Text="Regioes Registados" CssClass="form-label camposLabel" Style="font-weight: bold;"></asp:Label>
                    </div>
                </div>

                <%-- GRIDVIEW --%>
                <div class="container divCaixaGrid">
                    <asp:GridView ID="GridViewRegioes" runat="server" CssClass="table table-responsive table-hover" AllowSorting="True" HorizontalAlign="Center" AutoGenerateSelectButton="True" PageSize="6" OnSelectedIndexChanged="GridViewRegioes_SelectedIndexChanged" OnRowDataBound="GridViewRegioes_RowDataBound" AllowPaging="True" OnPageIndexChanging="GridViewRegioes_PageIndexChanging" EnableSortingAndPagingCallbacks="True">
