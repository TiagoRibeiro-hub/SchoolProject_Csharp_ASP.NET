<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Admin/indice2.master" AutoEventWireup="true" CodeBehind="formEnologos.aspx.cs" Inherits="WebVinhos.Admin.formEnologos" %>
            ...
            <div class="container d-flex flex-column">
                ...
                <div class="row g-3 divCaixaForms">
                    ...
                    <div class="col-md-12 divTitulo">
                        <asp:Label ID="LabelEnologos" runat="server" Text="Enologos" CssClass="tituloLabel"></asp:Label>
                    </div>
                    ...
                    <%-- Instagram --%>
                    <div class="col-md-12">
                        <asp:Label ID="LabelInstagram" runat="server" Text="Instagram" CssClass="form-label camposLabel"></asp:Label>
                        <asp:TextBox ID="TextBoxInstagram" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorInstagram" runat="server" ControlToValidate="TextBoxInstagram" Display="Dynamic" ErrorMessage="Só deve incluir letras, números e espaços" ValidationExpression="^[0-9a-zA-ZãáàéêíóõúçÃÁÀÉÊÍÓÕÚÇºª.,\s]+$" CssClass="valiTextNumeros"></asp:RegularExpressionValidator>
                    </div>
                    ...
                    <%-- Enologos Registados --%>
                    <div class="col-md-12 divTitulo">
                        <asp:Label ID="LabelEnologosRegistados" runat="server" Text="Enologos Registados" CssClass="form-label camposLabel" Style="font-weight: bold;"></asp:Label>
                    </div>
                </div>

                <%-- GRIDVIEW --%>
                <div class="container divCaixaGrid">
                    <asp:GridView ID="GridViewEnologos" runat="server" CssClass="table table-responsive table-hover" AllowSorting="True" HorizontalAlign="Center" AutoGenerateSelectButton="True" PageSize="6" AllowPaging="True" OnPageIndexChanging="GridViewEnologos_PageIndexChanging" OnRowDataBound="GridViewEnologos_RowDataBound" OnSelectedIndexChanged="GridViewEnologos_SelectedIndexChanged" EnableSortingAndPagingCallbacks="True">
